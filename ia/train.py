...
def eval_genomes(genomes, config):
    ...
    for genome_id, genome in genomes:
        ...
        if score > best_score_alltime:
            best_score_alltime = score
    print(f"Meilleur score obtenu : {best_score_gen}")
...
def run():
    ...
    print(f"Meilleur score all-time : {best_score_alltime}")
